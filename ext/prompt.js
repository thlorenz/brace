...
ace.define("ace/snippets",["require","exports","module","ace/lib/oop","ace/lib/event_emitter","ace/lib/lang","ace/range","ace/range_list","ace/keyboard/hash_handler","ace/tokenizer","ace/clipboard","ace/lib/dom","ace/editor"], function(acequire, exports, module) {
"use strict";
...
ace.define("ace/autocomplete",["require","exports","module","ace/keyboard/hash_handler","ace/autocomplete/popup","ace/autocomplete/util","ace/lib/lang","ace/lib/dom","ace/snippets","ace/config"], function(acequire, exports, module) {
"use strict";
...
ace.define("ace/ext/prompt",["require","exports","module","ace/range","ace/lib/dom","ace/ext/menu_tools/get_editor_keyboard_shortcuts","ace/autocomplete","ace/autocomplete/popup","ace/autocomplete/popup","ace/undomanager","ace/tokenizer","ace/ext/menu_tools/overlay_page","ace/ext/modelist"], function(acequire, exports, module) {
"use strict";

var Range = acequire("../range").Range;
var dom = acequire("../lib/dom");
var shortcuts = acequire("../ext/menu_tools/get_editor_keyboard_shortcuts");
var FilteredList= acequire("../autocomplete").FilteredList;
var AcePopup = acequire('../autocomplete/popup').AcePopup;
var $singleLineEditor = acequire('../autocomplete/popup').$singleLineEditor;
...
exports.prompt = prompt;
                    ...
                    ace.acequire(["ace/ext/prompt"], function(m) {
