...
ace.define("ace/mode/xml/sax",["require","exports","module"], function(acequire, exports, module) {
		...
		default:
			if(c<= ' '){//space
				...
				case S_ATTR_S:
					...
					break;
				case S_E:
					errorHandler.warning('attribute space is acequired"'+attrName+'"!!')
				case S_S:
					s = S_ATTR;
					start = p;
					break;
...
ace.define("ace/mode/xml/dom",["require","exports","module"], function(acequire, exports, module) {
...
ace.define("ace/mode/xml/dom-parser",["require","exports","module","ace/mode/xml/sax","ace/mode/xml/dom"], function(acequire, exports, module) {
	'use strict';

	var XMLReader = acequire('./sax'),
		DOMImplementation = acequire('./dom');
...
ace.define("ace/mode/xml_worker",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/worker/mirror","ace/mode/xml/dom-parser"], function(acequire, exports, module) {
"use strict";

var oop = acequire("../lib/oop");
var lang = acequire("../lib/lang");
var Mirror = acequire("../worker/mirror").Mirror;
var DOMParser = acequire("./xml/dom-parser").DOMParser;
