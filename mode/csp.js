ace.define("ace/mode/csp_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(acequire, exports, module) {
    "use strict";
    ...
    var CspHighlightRules = function() {
        var keywordMapper = this.createKeywordMapper({
            "constant.language": "child-src|connect-src|default-src|font-src|frame-src|img-src|manifest-src|media-src|object-src"
                  ...
                  + "|report-to|upgrade-insecure-requests|block-all-mixed-content|acequire-sri-for|reflected-xss|referrer|policy-uri",
...
ace.define("ace/mode/csp",["require","exports","module","ace/mode/text","ace/mode/csp_highlight_rules","ace/lib/oop"], function(acequire, exports, module) {
    "use strict";

    var TextMode = acequire("./text").Mode;
    var CspHighlightRules = acequire("./csp_highlight_rules").CspHighlightRules;
    var oop = acequire("../lib/oop");
    ...
    exports.Mode = Mode;
                ...
                (function() {
                    ace.acequire(["ace/mode/csp"], function(m) {
