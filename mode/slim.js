ace.define("ace/mode/slim_highlight_rules",["require","exports","module","ace/config","ace/lib/oop","ace/mode/text_highlight_rules"], function(acequire, exports, module) {
"use strict";

var modes = acequire("../config").$modes;
...
ace.define("ace/mode/markdown_highlight_rules",["require","exports","module","ace/config","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function(acequire, exports, module) {
"use strict";
...
ace.define("ace/mode/markdown",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/javascript","ace/mode/xml","ace/mode/html","ace/mode/markdown_highlight_rules","ace/mode/folding/markdown","ace/mode/javascript","ace/mode/html","ace/mode/sh","ace/mode/sh","ace/mode/xml","ace/mode/css"], function(acequire, exports, module) {
"use strict";
...
var Mode = function() {
    ...
    this.createModeDelegates({
        javascript: acequire("./javascript").Mode,
        html: acequire("./html").Mode,
        bash: acequire("./sh").Mode,
        sh: acequire("./sh").Mode,
        xml: acequire("./xml").Mode,
        css: acequire("./css").Mode
    });
...
ace.define("ace/mode/scss_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules","ace/mode/css_highlight_rules"], function(acequire, exports, module) {
"use strict";
...
ace.define("ace/mode/scss",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/scss_highlight_rules","ace/mode/matching_brace_outdent","ace/mode/behaviour/css","ace/mode/folding/cstyle","ace/mode/css_completions"], function(acequire, exports, module) {
"use strict";
...
ace.define("ace/mode/slim",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/slim_highlight_rules","ace/mode/javascript","ace/mode/markdown","ace/mode/coffee","ace/mode/scss","ace/mode/sass","ace/mode/less","ace/mode/ruby","ace/mode/css"], function(acequire, exports, module) {
"use strict";

var oop = acequire("../lib/oop");
var TextMode = acequire("./text").Mode;
var SlimHighlightRules = acequire("./slim_highlight_rules").SlimHighlightRules;
...
var Mode = function() {
    ...
    this.createModeDelegates({
        javascript: acequire("./javascript").Mode,
        markdown: acequire("./markdown").Mode,
        coffee: acequire("./coffee").Mode,
        scss: acequire("./scss").Mode,
        sass: acequire("./sass").Mode,
        less: acequire("./less").Mode,
        ruby: acequire("./ruby").Mode,
        css: acequire("./css").Mode
    });
};
...
exports.Mode = Mode;
                    ...
                    ace.acequire(["ace/mode/slim"], function(m) {
