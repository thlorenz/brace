...
ace.define("ace/mode/livescript",["require","exports","module","ace/tokenizer","ace/mode/matching_brace_outdent","ace/mode/behaviour/cstyle","ace/mode/text"], function(acequire, exports, module){
  ...
  exports.Mode = LiveScriptMode = (function(superclass){
    ...
    function LiveScriptMode(){
      ...
      this.$behaviour = new (acequire("./behaviour/cstyle").CstyleBehaviour)();
    }
...
function import$(obj, src){
  ...
  return obj;
                ...
                (function() {
                    ace.acequire(["ace/mode/livescript"], function(m) {
