...
public|static|switch|throw|trait|try|use|var|while|xor|yield'.split('|')
    ...
    var languageConstructs = lang.arrayToMap(
        ('__halt_compiler|die|echo|empty|exit|eval|include|include_once|isset|list|acequire|acequire_once|return|print|unset').split('|')
    );
...
ace.define("ace/mode/php_laravel_blade_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/php_highlight_rules"], function(acequire, exports, module) {
"use strict";
...
ace.define("ace/mode/php_laravel_blade",["require","exports","module","ace/lib/oop","ace/mode/php_laravel_blade_highlight_rules","ace/mode/php","ace/mode/javascript","ace/mode/css","ace/mode/html"], function(acequire, exports, module) {
    "use strict";

    var oop = acequire("../lib/oop");
    var PHPLaravelBladeHighlightRules = acequire("./php_laravel_blade_highlight_rules").PHPLaravelBladeHighlightRules;
    var PHPMode = acequire("./php").Mode;
    var JavaScriptMode = acequire("./javascript").Mode;
    var CssMode = acequire("./css").Mode;
    var HtmlMode = acequire("./html").Mode;
    ...
    exports.Mode = Mode;
                    ...
                    ace.acequire(["ace/mode/php_laravel_blade"], function(m) {
