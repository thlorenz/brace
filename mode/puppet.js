ace.define("ace/mode/puppet_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function (acequire, exports, module) {
"use strict";
...
var PuppetHighlightRules = function () {
    this.$rules = {
        "start": [
            ...
            {
                token: "keyword.control.puppet",
                regex: "\\b(import|default|inherits|include|acequire|contain|node|application|consumes|environment|site|function|produces)\\b"
            },
            {
...
ace.define("ace/mode/puppet",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/puppet_highlight_rules","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle","ace/mode/matching_brace_outdent"], function (acequire, exports, module) {
"use strict";

var oop = acequire("../lib/oop");
var TextMode = acequire("./text").Mode;
var PuppetHighlightRules = acequire("./puppet_highlight_rules").PuppetHighlightRules;
...
exports.Mode = Mode;
                    ...
                    ace.acequire(["ace/mode/puppet"], function(m) {
