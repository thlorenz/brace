...
ace.define("ace/mode/behaviour/liquid",["require","exports","module","ace/lib/oop","ace/mode/behaviour","ace/mode/behaviour/xml","ace/token_iterator","ace/lib/lang"], function(acequire, exports, module) {
    "use strict";
    
    var oop = acequire("../../lib/oop");
    var Behaviour = acequire("../behaviour").Behaviour;
    var XmlBehaviour = acequire("./xml").XmlBehaviour;
    var TokenIterator = acequire("../../token_iterator").TokenIterator;
    var lang = acequire("../../lib/lang");
...
ace.define("ace/mode/liquid",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/html","ace/mode/html_completions","ace/mode/behaviour/liquid","ace/mode/liquid_highlight_rules","ace/mode/matching_brace_outdent"], function(acequire, exports, module) {

var oop = acequire("../lib/oop");
var TextMode = acequire("./text").Mode;
var HtmlMode = acequire("./html").Mode;
var HtmlCompletions = acequire("./html_completions").HtmlCompletions;
var LiquidBehaviour = acequire("./behaviour/liquid").LiquidBehaviour;
...
exports.Mode = Mode;
                    ...
                    ace.acequire(["ace/mode/liquid"], function(m) {
